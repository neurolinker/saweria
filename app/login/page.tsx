      ...
      <>
          ...
          <div className = "flex text-sm mb-14 w-full">
              ...
              <div className = "relative text-sm md:text-md bg-[#D0E2DB] rounded-lg p-3 border border-black text-gray-600 w-full">
                  ...
                  <div className = "my-3 text-2xl text-center text-black font-comMedium">Login</div>
                  <div className = " w-full">
                    ...
                    <div className = "flex h-14 w-full flex-row justify-center items-center ">
                      <div className = "flex w-1/2 ">Lupa Password</div>
                      <div className = "flex w-1/2 items-center justify-center">
                        <div className = "flex relative w-full p-2 items-center mr-2">
                          <div className ="flex absolute rounded-lg -top-1 -right-3 bg-[#222222] py-2 px-1 w-full flex-grow">asd</div>

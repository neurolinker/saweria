        ...
        <div className = "flex flex-col items-center justify-center mt-6">
            ...
            <div className="flex justify-center space-x-10 mb-10">
                <div className = "flex w-full">
                    {/* container */}
                    <div className = "flex  items-center justify-center relative bg-[#8BD3DD] rounded-lg px-5 py-2 border border-black text-gray-600 w-full">
                        Login
                ...
                <div className = "flex w-full">
                    {/* container */}
                    <div className = "flex  items-center justify-center relative bg-[#FAAE2B] rounded-lg px-5 py-2 border border-black text-gray-600 w-full">
                        Daftar
                        <div className ="absolute h-full rounded-lg top-2 -right-2 bg-[#222222] py-2 px-1 w-full flex-grow -z-10">asd</div>
                    </div>
                </div>
            ...
            <div className = "flex justify-center items-center flex-col mb-14">
                <div className = "flex pl-14 w-full  justify-center h-36 ">
                    <img className = "object-cover" src= "https://saweria.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcapy_happy.603c7293.svg&w=384&q=75"/>
                </div>
                <div className = "font-comRegular justify-center text-center flex  text-xl">siap bergabung bersama saweria?</div>
                <div className = "flex w-1/5">
                    {/* container */}
                    <div className = "flex  items-center justify-center relative bg-[#FAAE2B] rounded-lg py-2 px-1 border border-black text-gray-600 w-full">
                        Daftar
            ...
            <div className = "flex font-comRegular text-sm mb-10">
                ...
                <div className = "relative flex justify-center bg-[#D0E2DB] rounded-b-lg rounded-l-lg px-3 py-5 border border-black text-gray-600 w-full">
                    <div className = "flex flex-row">
                        ...
                        <div className = "flex  justify-center h-auto w-5/6 mx-4">
            ...
            <div className = "flex font-comRegular text-sm mb-10 w-full">
                {/* container */}
                <div className = "relative flex justify-center bg-[#FFBDC4] rounded-b-lg rounded-t-lg px-1 py-4 border border-black text-gray-600 w-full">
                    <div className = "flex flex-row items-center justify-center w-full">
                        ...
                        <div className="flex text-xl flex-col md:text-2xl items-center text-center  justify-center px-2 w-4/6">
            ...
            <div className="flex flex-col sm:flex-row  mb-10 w-full sm:space-x-4">
                <div className = "flex w-full md:w-1/2">
                    {/* container */}
                    <div className = "flex mb-4 sm:mb-0 items-center justify-center relative bg-[#FAAE2B] rounded-lg py-4 px-1 border border-black text-gray-600 w-full">
                        Tutorial
                ...
                <div className = "flex w-full md:w-1/2">
                    {/* container */}
                    <div className = "flex  items-center justify-center relative bg-[#8BD3DD] rounded-lg py-4 px-1 border border-black text-gray-600 w-full">
            ...
            <div className="flex w-full mb-10">
                <div className = "flex flex-col w-1/2 mr-4 text-sm">
                    {/* container */}
                    <div className = "mb-5">
                        Made with 💙 from NRL
                    </div>
                ...
                <div className = "flex justify-end items-end flex-col w-1/2 ml-4">
                    {/* container */}
                    <div className = "">
                        Syarat dan Ketentuan
                    </div>
